...
/> :<div  className="d-flex justify-content-center  flex-column align-content-center">
            ...
            <h1  className="fs-1"   style={{color:"#c5e976"}}>PDF TO PPT</h1>
           <label className="fs-3 form-label">Convert PDF To ppt in seconds. 
</label>
          <input
...
{!enabledownload &&
      ...
      Convert to ppt<i className="fa-solid fa-right-arrow"></i> 
        </button>}
